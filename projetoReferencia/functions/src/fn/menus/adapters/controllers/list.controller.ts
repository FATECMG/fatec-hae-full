...
import { IListMenus } from '../../usecases/list.usecase'

@injectable()
export class ListMenusController implements Handler {
  constructor(@inject(Locator.ListMenuUseCase) private usecase: IListMenus) {}
