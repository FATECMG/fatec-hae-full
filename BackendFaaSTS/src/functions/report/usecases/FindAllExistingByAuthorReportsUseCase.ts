...
@injectable()
export class FindAllExistingByAuthorReportsUseCase implements FindAllUseCase<Report> {
  constructor (
    @inject(ReportRepositoryLocator.FindAllExistingByAuthorReportsRepository)
