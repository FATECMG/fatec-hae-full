import { type SaveUseCaseFromInterface } from '@common/domain/UseCase.interface'
...
@injectable()
export class SaveReportUseCase implements SaveUseCaseFromInterface<Report, CreateReportUseCaseProps> {
  constructor (
