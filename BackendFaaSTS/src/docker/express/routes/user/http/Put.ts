...
const putController = UserDependencies.get<UpdateController<UserDTO, User, UserPresentationModel>>(UserLocator.UserUpdateController)

export const PutUserHandler = async (req: any, id?: string): Promise<HttpResponse<string | UserPresentationModel | FieldError | FieldError[]>> => {
  if (id === undefined) {
