...
const activateController = UserDependencies.get<ActivateController<User>>(UserLocator.UserActivateController)

export const PatchActivateUserHandler = async (id?: string): Promise<HttpResponse<string>> => {
  if (id === undefined) {
